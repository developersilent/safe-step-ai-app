      ...
      <View>
        {languages.map((lang) => (
          <TouchableOpacity
            ...
            className={`flex-row px-5 items-center gap-3 rounded-xl mt-4 py-3 justify-between border-b border-neutral-500/20`}
            activeOpacity={0.6}
          >
            <Text
              className={`text-fuchsia-200 text-md font-bold text-center ${selectedLanguage === lang.code ? "text-bold text-indigo-500 text-xl" : ""}`}
            >
              {lang.label}
            </Text>
            <Text
