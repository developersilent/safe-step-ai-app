...
import { default as RightArrowIcon, default as SettingIcon } from '@expo/vector-icons/MaterialIcons';
...
export default function Index() {
  ...
  return (
    <View className="w-full flex relative items-center bg-dark justify-center h-full">
      <TouchableOpacity className="absolute top-7 right-7 p-2" activeOpacity={0.6} onPress={handleSettingsPress}>
      ...
      <View className="w-[80%] h-fit">
        ...
        />
        <TouchableOpacity className="border w-full bg-indigo-600 flex-row gap-1 items-center justify-center p-3 rounded-full" activeOpacity={0.8} onPress={handleNextPress}>
